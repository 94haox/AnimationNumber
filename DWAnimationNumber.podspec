#
#  Be sure to run `pod spec lint DWAnimationNumber.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "DWAnimationNumber"
  s.version      = "1.0.0"
  s.summary      = "animation number"
  ...
  s.source       = { :git => "https://github.com/94haox/AnimationNumber.git", :tag => "#{s.version}" }
